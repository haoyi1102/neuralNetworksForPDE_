function result=assemble_matrix_from_C_integral_left(i,result1_2,t_partition,M_partition,T_partition,T_basis,number_of_trial_local_basis,...
...
for n=1:number_of_elements
    ...
    for alpha=1:number_of_trial_local_basis
       for beta=1:number_of_test_local_basis      
          temp=Gauss_quadrature_for_C_integral_trial_test_left(i,n,result1_2,t_partition,vertices,T_basis,Gauss_coefficient_local_1D,...
