function result=global_function1(result1_1,vertices,T_basis,x,j,n,derivative_degree)
...
%         if test_derivative_degree==0
        result=result+vertices_solution(i)*local_basis_1D_reference(x,vertices,i,derivative_degree);
%         else 
