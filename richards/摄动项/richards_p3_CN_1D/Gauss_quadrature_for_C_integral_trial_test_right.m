function result=Gauss_quadrature_for_C_integral_trial_test_right(j,n,result1_1,result1_2,T,t_partition,vertices,T_basis,...
    Gauss_coefficient_local_1D,Gauss_point_local_1D,test_basis_index,test_derivative_degree)
