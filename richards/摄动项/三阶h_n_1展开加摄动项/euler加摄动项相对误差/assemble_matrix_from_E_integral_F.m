function result=assemble_matrix_from_E_integral_F(T_basis,M_partition,T_partition,number_of_trial_local_basis,number_of_test_local_basis,...
...
for n=1:number_of_elements
    ...
    for alpha=1:number_of_trial_local_basis
       for beta=1:number_of_test_local_basis      
          temp=Gauss_quadrature_for_E_integral_trial_test_F(vertices,Gauss_coefficient_local_1D,Gauss_point_local_1D,alpha,...
