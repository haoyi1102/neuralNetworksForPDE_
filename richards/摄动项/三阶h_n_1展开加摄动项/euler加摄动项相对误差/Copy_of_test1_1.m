function result=Copy_of_test1_1(left,right,T,h_partition,t_partition,Gauss_point_number)
%Copy_of_test1_1(0,40,10,1,1,4)
...
%将每一时间层的数值解放进对应矩阵的列
result=zeros(2*N_partition+2,2);
...
%通过循环得到每一层的结果
for j=2:3
    result(:,j)=local_richards_solver_F(T,t_partition,N_partition,M_partition,T_partition,M_basis,T_basis,Gauss_coefficient_reference_1D,...
