function result=Gauss_quadrature_for_C_integral_trial_test_E(j,n,result1_1,t_partition,vertices,T_basis,Gauss_coefficient_local_1D,Gauss_point_local_1D,trial_basis_index,trial_derivative_degree,test_basis_index,test_derivative_degree)
