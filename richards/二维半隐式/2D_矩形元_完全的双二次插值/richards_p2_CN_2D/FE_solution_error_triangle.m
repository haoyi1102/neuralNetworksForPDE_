...
[Gauss_coefficient_reference_triangle,Gauss_point_reference_triangle]=generate_Gauss_reference_rectangular(Gauss_point_number);
...
for n=1:number_of_elements
    ...
    r=r+Gauss_quadrature_for_volume_integral_FE_solution_error_triangle(uh_local,accurate_function_local,vertices,Gauss_coefficient_reference_triangle,Gauss_point_reference_triangle,derivative_degree_x,derivative_degree_y);
end
r=sqrt(r);