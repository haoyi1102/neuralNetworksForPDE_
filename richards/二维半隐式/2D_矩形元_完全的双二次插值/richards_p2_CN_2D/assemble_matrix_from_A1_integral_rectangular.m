...
for n=1:number_of_elements
    ...
    for alpha=1:number_of_trial_local_basis
       for beta=1:number_of_test_local_basis      
          temp=Gauss_quadrature_for_A1_integral_trial_test_rectangular(n,result2,j,dt,T_basis_trial,Gauss_coefficient_local_rectangular,Gauss_point_local_rectangular,vertices,alpha,trial_derivative_degree_x,trial_derivative_degree_y,beta,test_derivative_degree_x,test_derivative_degree_y);
