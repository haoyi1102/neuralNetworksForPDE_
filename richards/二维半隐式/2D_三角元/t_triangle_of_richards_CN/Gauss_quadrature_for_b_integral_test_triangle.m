...
for i=1:Gpn
      ...
      r=r+(2/dt)*Gauss_coefficient_local(i)*C*global_solver*triangular_local_basis(Gauss_point_local(i,1),Gauss_point_local(i,2),vertices,test_basis_index,test_derivative_degree_x,test_derivative_degree_y);
end