...
for n=1:number_of_elements
    ...
    for alpha=1:number_of_trial_local_basis
       for beta=1:number_of_test_local_basis      
          temp=Gauss_quadrature_for_A2_integral_trial_test_triangle(n,result1_1,j,T_basis_test,Gauss_coefficient_local_triangle,Gauss_point_local_triangle,vertices,alpha,trial_derivative_degree_x,trial_derivative_degree_y,beta,test_derivative_degree_x,test_derivative_degree_y);
