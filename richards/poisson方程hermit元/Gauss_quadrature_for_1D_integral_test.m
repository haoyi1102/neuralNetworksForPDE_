function result=Gauss_quadrature_for_1D_integral_test(coefficient_function_name,Gauss_coefficient_local_1D,Gauss_point_local_1D,...
    test_vertices,test_basis_index,test_derivative_degree)
%Use Gauss quadrature to compute a 1D integral for a vector.使用高斯正交计算矢量的一维积分。
