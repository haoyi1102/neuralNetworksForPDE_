function result=assemble_vector_from_1D_integral(coefficient_function_name,M_partition,T_partition,T_basis_test,...
...
for n=1:number_of_elements
    ...
    for beta=1:number_of_test_local_basis     
        temp=Gauss_quadrature_for_1D_integral_test(coefficient_function_name,Gauss_coefficient_local_1D,Gauss_point_local_1D,vertices,...
