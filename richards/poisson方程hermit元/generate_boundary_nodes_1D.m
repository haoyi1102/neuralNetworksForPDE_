...
%boundary_nodes(1,k): specifiy the type of the kth boundary node.指定第 k 个边界节点的类型。
...
%boundary_nodes(2,k): global index of the kth boundary node among all nodes of FE. FE 的所有节点中第 k 个边界节点的全局索引。
