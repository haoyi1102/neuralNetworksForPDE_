function result=assemble_matrix_from_dK_integral_right(i,result1_1,result1_2,M_partition,T_partition,T_basis,number_of_test_local_basis,number_of_elements,vector_size,Gauss_coefficient_reference_1D,Gauss_point_reference_1D,test_derivative_degree)
...
for n=1:number_of_elements
    ...
    for beta=1:number_of_test_local_basis      
        temp=Gauss_quadrature_for_dK_integral_trial_test_right(i,n,result1_1,result1_2,vertices,T_basis,Gauss_coefficient_local_1D,Gauss_point_local_1D,beta,test_derivative_degree); 
