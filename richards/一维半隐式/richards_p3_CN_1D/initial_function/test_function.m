function result=test_function(left,right,T,h_partition,t_partition,basis_type,Gauss_point_number)
...
result(:,1)=result1_1;
% result(:,2)=local_richards_solver(left,right,T,h_partition,t_partition,basis_type,Gauss_point_number,j-1,result(:,j-1));
