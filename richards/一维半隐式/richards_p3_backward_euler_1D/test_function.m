...
%通过循环得到每一层的结果
for j=2:t_number+1
    result(:,j)=local_richards_solver(T,t_partition,N_partition,M_partition,T_partition,M_basis,T_basis,Gauss_coefficient_reference_1D,Gauss_point_reference_1D,number_of_elements,number_of_trial_local_basis,number_of_test_local_basis,matrix_size,vector_size,j-1,result(:,j-1));
end
